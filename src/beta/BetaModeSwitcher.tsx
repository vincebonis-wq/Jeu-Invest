...
const MODES: { id: UiMode; emoji: string; label: string; desc: string }[] = [
  ...
  { id: 'tycoon',  emoji: '🏭', label: 'Beta · Tycoon', desc: 'Empire idle : gestionnaires + prestige' },
  { id: 'terminal',emoji: '📈', label: 'Beta · Le Terminal', desc: 'Salle des marchés — trading actif' },
