        ...
        <nav className="flex flex-col gap-1">
          {NAV.map((item) => (
            <NavButton
              ...
              hasTraining={item.screen === 'skills' && !!activeTraining}
        ...
        {NAV.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.screen === 'skills' && activeTraining && (
                <span className="absolute top-0 right-1 w-3 h-3 rounded-full bg-brand-500 animate-pulse" />
              )}
            </button>
          )
        })}
